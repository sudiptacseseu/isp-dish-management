...
public class updateInfo2_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(updateInfo2_Activity.this, date, myCalendar
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.update_info_id){
            Boolean isUpdated = myDatabaseHelper.updateData(id,name,contact,address,taka,status,date);
