...
public class addUser_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(addUser_Activity.this, date, myCalendar
    ...
    public void onClick(View view) {
        ...
        {
           long rowId = myDatabaseHelper.insertData(id,name,contact,address,bandwidth,taka,ip,status,date);
           if(rowId == -1){
